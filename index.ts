...
export const buildPostApi = <TInput, TOutput>(api: PostApi<TInput, TOutput>): APIGatewayHandler =>
    withHttpLogging(withCors(withJsonErrorHandling(withJsonPost<TInput, TOutput>(api))));
